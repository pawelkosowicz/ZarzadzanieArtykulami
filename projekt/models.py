...
class Comments(models.Model):
    ...
    idnews = models.ForeignKey('News', models.DO_NOTHING, db_column='idNews', blank=True, null=True)  # Field name made lowercase.
...
class Forumcomments(models.Model):
    ...
    idforumtopic = models.ForeignKey('Forumtopics', models.DO_NOTHING, db_column='idForumTopic', blank=True, null=True)  # Field name made lowercase.
    auth_user = models.ForeignKey(AuthUser, models.DO_NOTHING)
